...
$backup | ForEach-Object -Parallel {
    ...
    $b   = Invoke-SFApi -Method StartBulkVolumeRead -Params @{ "volumeID"= "$_"; "snapshotID" = $snapshotID ; "format" = "native"; "script" = "bv_internal.py"; "scriptParameters" = @{ "write" = @{ "awsAccess KeyID" = "AAAAAAAAAAAA"; "awsSecretAccessKey" = "BBBBBBBBBBB"; "bucket"= "backup"; "endpoint" = "s3"; "hostname" = "1.2.3.4:443" ; "prefix" = $prefix}}}
